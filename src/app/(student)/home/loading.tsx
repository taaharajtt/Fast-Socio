...
export default function HomeLoading() {
  return (
    // Geometry mirrors the real Home shell exactly — px-4 (not px-5), a
    // 104px masthead sized for the 85px logo, and two 40px round controls —
    ...
    <main className="mx-auto w-full max-w-md pb-4">
      <div className="flex h-[104px] items-center justify-between px-4">
        <Skeleton className="h-[85px] w-44" />

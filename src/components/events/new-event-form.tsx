 ...
 * caller is an owner/moderator of that community); it rides along as a hidden
 * field. The "students submit pending events" RLS policy is the real guard —
 * it re-checks owner/moderator membership at insert time regardless.
 */
  ...
  return (
    <main className="mx-auto w-full max-w-md px-5 py-6">
      <div className="mb-4 flex items-center gap-3">
        <Link
          href={communityId ? `/societies/${communityId}` : "/communities"}
          aria-label="Back"
      ...
      {communityName && (
        <p className="mb-4 text-sm text-fg-muted">
          Hosting for <span className="font-semibold text-fg">{communityName}</span>
        </p>
      )}
